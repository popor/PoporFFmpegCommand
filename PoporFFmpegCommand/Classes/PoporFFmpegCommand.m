...
#import "PoporFFmpegCommand.h"

#import <AVFoundation/AVFoundation.h>
#import <MediaPlayer/MediaPlayer.h>

@implementation PoporFFmpegCommand
...
+ (NSString * _Nullable)ffmpegCommand_VideoPath:(NSString * _Nonnull)videoPath tSize:(CGSize)tSize tPath:(NSString * _Nonnull)tPath {
    ...
    CGSize oSize = [PoporFFmpegCommand videoSizeFromPath:videoPath];
    CGSize rSize = [PoporFFmpegCommand sizeFrom:oSize targetSize:tSize];
